...
val DropNestLogo: ImageVector by lazy {
    ImageVector.Builder(name = "DropNestLogo", defaultWidth = 64.dp, defaultHeight = 64.dp, viewportWidth = 64f, viewportHeight = 64f).apply {
