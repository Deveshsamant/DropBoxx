...
class BoxIntegrationTest {
    ...
    fun setUp() = runBlocking<Unit> {
        root = Files.createTempDirectory("dropnest-box").toFile()
    ...
    fun boxSurvivesRestartAndPeerCanFetchAfterApproval() = runBlocking<Unit> {
        ...
        assertEquals(3, com.dropnest.engine.box.BoxRepositoryImpl(bob.dir.absolutePath, bob.platform).items.value.size)
